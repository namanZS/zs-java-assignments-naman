...
public class Main {
    ...
    private static void addProduct() {
        ...
        if (categoryNumber >= 1 && categoryNumber <= catalogue.getCategories().size()) {
            ...
            boolean returnable = true;  // Default to true

            if (category.getName().equalsIgnoreCase("PersonalCare")) {
                // Set returnable to false for PersonalCare products
                returnable = false;
                ...
                // Create a generic product for other categories
    ...
    private static void deleteProduct() {
        ...
        if (categoryNumber >= 1 && categoryNumber <= catalogue.getCategories().size()) {
            ...
            // Display a numbered list of products in the specified category
            int productIndex = 1;
    ...
    /**
     * Method to display all products in a specific category.
     */
    /**
    ...
    private static void getAllProduct() {
        ...
        for (Category category : catalogue.getCategories()) {
            ...
            // Display a numbered list of products in the current category
            int productIndex = 1;
            for (Product product : category.getProducts()) {
                String productInfo;
